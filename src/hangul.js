...
(function (root) {
  ...
  var BOX = {
    ...
    /* 복합모음(ㅘ ㅚ ㅟ ㅞ …)은 초성이 왼쪽 위에 온다.
     * 이때 초성 자리를 좁게 잡으면 '위 · 의 · 킈' 처럼 초성만 작게 떠 보인다.
     * 사용자는 초성을 가로모음용(폭 0.72)으로 썼으므로, 자리도 그에 가깝게 준다.
     * 오른쪽 세로획(ㅣ)이 대략 0.8 부터 시작하므로 0.64 까지가 안전하다. */
    M: {
      noJong: { cho: [0.03, 0.00, 0.64, 0.52], jung: [0.00, 0.00, 1.00, 1.00] },
      jong:   { cho: [0.03, 0.00, 0.62, 0.38], jung: [0.00, 0.00, 1.00, 0.68],
